...
ActiveRecord::Schema.define(:version => 20120324014857) do
  ...
  create_table "member_host_projects", :force => true do |t|
    t.integer  "member_id"
  ...
  create_table "member_liked_projects", :force => true do |t|
    t.integer  "member_id"
    t.integer  "project_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "return_methods", :force => true do |t|
    t.integer  "project_id"
    t.integer  "money1"
    t.integer  "money2"
    t.integer  "money3"
  ...
  add_index "return_methods", ["id"], :name => "index_return_methods_on_id"
