...
Feature: Members
  ...
  Scenario: Create Valid Member
    ...
    And I fill in "Member Name" with "This is a test of the first string field"
    And I press "Save"
    Then I should see "'This is a test of the first string field' was successfully added."
    And I should have 1 member

  @members-invalid @invalid
  Scenario: Create Invalid Member (without member_name)
    When I go to the list of members
    And I follow "Add New Member"
    And I press "Save"
    Then I should see "Member Name can't be blank"
    And I should have 0 members

  @members-edit @edit
  Scenario: Edit Existing Member
    Given I have members titled "A member_name"
    When I go to the list of members
    And I follow "Edit this member" within ".actions"
    Then I fill in "Member Name" with "A different member_name"
    And I press "Save"
    Then I should see "'A different member_name' was successfully updated."
    And I should be on the list of members
    And I should not see "A member_name"
  ...
  Scenario: Create Duplicate Member
    ...
    When I go to the list of members
    And I follow "Add New Member"
    And I fill in "Member Name" with "UniqueTitleTwo"
    And I press "Save"
