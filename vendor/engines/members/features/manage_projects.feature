...
Feature: Projects
  ...
  Scenario: Create Valid Project
    ...
    And I fill in "Case Name" with "This is a test of the first string field"
    And I press "Save"
    Then I should see "'This is a test of the first string field' was successfully added."
    And I should have 1 project

  @projects-invalid @invalid
  Scenario: Create Invalid Project (without case_name)
    When I go to the list of projects
    And I follow "Add New Project"
    And I press "Save"
    Then I should see "Case Name can't be blank"
    And I should have 0 projects

  @projects-edit @edit
  Scenario: Edit Existing Project
    Given I have projects titled "A case_name"
    When I go to the list of projects
    And I follow "Edit this project" within ".actions"
    Then I fill in "Case Name" with "A different case_name"
    And I press "Save"
    Then I should see "'A different case_name' was successfully updated."
    And I should be on the list of projects
    And I should not see "A case_name"
  ...
  Scenario: Create Duplicate Project
    ...
    When I go to the list of projects
    And I follow "Add New Project"
    And I fill in "Case Name" with "UniqueTitleTwo"
    And I press "Save"
